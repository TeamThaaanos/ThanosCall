...
const BtnGrpCsStatics = () => {
  const [selectedLarge, setSelectedLarge] = useState("CS 통계")
  const [selectedSmall, setSelectedSmall] = useState("상담원 통계")
    ...
    <div style={styles.container}>
      ...
      <div style={styles.buttonWrapper}>
        <div style={styles.smallButtonGroup}>
          ...
          <SButtonColored
            text="상담원 통계"
            onClick={() => setSelectedSmall("상담원 통계")}
            style={
              selectedSmall === "상담원 통계"
                ? styles.activeSmall
...
export default BtnGrpCsStatics
